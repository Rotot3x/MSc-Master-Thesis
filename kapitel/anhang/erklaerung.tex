...
%-----------------------------------
% Ehrenwörtliche Erklärung Author 1
%-----------------------------------
\section*{%
...
\begin{table}[H]
	...
	\begin{tabular*}{\textwidth}{c @{\extracolsep{\fill}} ccccc}
		...
		\langde{(Ort, Datum)}\langen{(Location, Date)} & \langde{Ferris Florian Menzel}\langen{(handwritten signature)}
		\\
	\end{tabular*} \\
\end{table}
...
\newpage
%-----------------------------------
% Ehrenwörtliche Erklärung Author 2
%-----------------------------------
%\section*{%
%	\langde{Ehrenwörtliche Erklärung}
%	\langen{Declaration in lieu of oath}}
...
%		\\
%		\rule[0.5ex]{12em}{0.55pt} & \rule[0.5ex]{12em}{0.55pt} \\
%		\langde{(Ort, Datum)}\langen{(Location, Date)} & \langde{Author 2}\langen{(handwritten signature)}
%		\\
%	\end{tabular*} \\
%\end{table}
