...
SSI nutzt Identifikatoren, die keine Registrierungsstellen oder Identity Provider erfordern, wobei die häufigsten Identifikatoren dem \ac{DID}-Standard des W3C folgen \parencite[S. 5]{naghmouchi_SystematicReviewLayeredFrameworkPrivacybyDesignSelfSovereignIdentitySystems_2025}. DIDs werden von ihren Eigentümern erstellt, sind mit einem public Key verknüpft, der einem private Key zugeordnet ist, sodass die Eigentümerschaft durch Challenge-Response-Verfahren verifiziert werden kann \parencite[S. 5]{naghmouchi_SystematicReviewLayeredFrameworkPrivacybyDesignSelfSovereignIdentitySystems_2025}. Jede DID ist mit einem DID-Dokument verbunden, das öffentliche Schlüssel und Service-Endpoints enthält \parencite[S. 23]{strueker_SelfSovereignIdentityGrundlagenAnwendungenundPotenzialeportablerdigitalerIdentitaeten_2021}.
