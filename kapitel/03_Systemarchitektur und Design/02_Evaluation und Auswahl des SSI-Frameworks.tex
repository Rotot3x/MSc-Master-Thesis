...
Das Herzstück von blockchainbasiertem SSI

Das Herzstück von SSI sind drei fundamentale Komponenten:

    Decentralized Identifiers (DIDs) - eindeutige Identifikatoren

Verifiable Credentials - kryptographisch signierte digitale Nachweise

Verifiable Data Registry (Blockchain) - unveränderliche Registrierung für Verifikation

Die kritischen kryptographischen Schnittstellen in deinem Indy-Besu System sind:

    DID-Erzeugung und -Management (Contract: 0x3333)

    Credential Definition Signing (Contract: 0x4444)

    Schema-Validierung (Contract: 0x5555)

    Node-zu-Node Kommunikation (QBFT Konsens)




https://lacnet.com/generation-of-post-quantum-certificates/ ==> 

We decided not to modify this protocol because that would require maintenance of a new blockchain technology. Instead, our goal was to keep using the Hyperledger Besu technology and develop a layer on top to make it quantum-resistant.
