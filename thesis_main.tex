...
\newcounter{manualListingCounterA}

% Caption-Format für Listings: Nummer und Titel auf separaten Zeilen
\makeatletter
\renewcommand\lst@makecaption[2]{%
  \vskip\abovecaptionskip
  {\textbf{Listing A-\themanualListingCounterA}\par\textit{#2}\par}%
  \vskip\belowcaptionskip
}
\makeatother

\renewcommand{\thelstlisting}{Listing A-\arabic{manualListingCounterA}:}
\renewcommand{\theHlstlisting}{Listing A-\arabic{manualListingCounterA}:} % für hyperref
